import smtplib
import ssl
from app.helper.template import templateHTML, templateVerifEmail
...
def sendVerifyEmail(username, uuid, emailuser):
    email_sender = 'gt20sc3@gmail.com'
    email_password = 'vmrhsyyzuznzeqxh'
    email_receiver = emailuser
    ...
    subject = f'Verify Your Email Account Fashion Campuss {date_str}'
    body = templateVerifEmail(username, uuid)
